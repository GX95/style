...
#hargai dong kontol ..bikin tidak semudah memakai
import os
import sys
import time
#warna
...
def tik():
	muter = ['[\]    ','[/]    ','[-]    ','[\]    ','[/]    ','[-]    ','[\]    ','[/]    ','[-]    ','[\]    ','[/]    ','[-]    ','[\]    ','[/]    ','[-]    ','[\]    ','[/]    ','[-]    ','[\]    ','[-]    ','[\]    ','[/]    ','[-]    ','[\]    ','[/]    ','[-]    ','[\]    ','[/]    ','[-]    ','[\]    ','\033[91m[ \033[92mS U C C E S \033[91m]']
	for o in muter:
...
def banner():
    ...
    time.sleep(0.1)
    print b+"  ║ \033[95m[\033[92m3\033[95m]\033[93m Tengkorak         \033[94m║ \033[95m[\033[92m6\033[95m]\033[93m Tampilan Kucing"
    time.sleep(0.1)
    print m+"✠\033[94m═╬════════════════════════════════════════════════════\033[91m✠"
def pilih(): 
